...
public class TempPassword_change_for_old_user_who_has_never_logged_in_before_deployment_Page extends PageBase{
	public TempPassword_change_for_old_user_who_has_never_logged_in_before_deployment_Page(RemoteWebDriver remoteDriver) {
		super(remoteDriver);
	}
	...
	public void verifyResetPassword(String password) throws Exception
	{
		...
		enterText(newPasswordTextBox,"Change1234","Current Password");
		enterText(confirmNewPasswordTextBox,"Change1234","Current Password");
