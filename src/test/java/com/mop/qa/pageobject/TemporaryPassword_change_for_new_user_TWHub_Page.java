...
public class TemporaryPassword_change_for_new_user_TWHub_Page extends PageBase {
	
	public TemporaryPassword_change_for_new_user_TWHub_Page(RemoteWebDriver remoteDriver) {
		super(remoteDriver);
	}
	...
	@FindBy(xpath="//a[contains(text(),'Sign in to Telstra Wholesale Hub')]")
	...
	{
		isDisplayed(signOutBtn,"Dashboard");
	}
}
